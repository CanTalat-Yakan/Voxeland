...
public class PlayerRayCast : MonoBehaviour
{
    ...
    // // internal VoxelEngineChunk m_TargetChunk, m_CurrentChunk;
    ...
    //         Destroy(Instantiate(m_blockPX, m_TargetBlockPos.Value, Quaternion.identity), 3);
            
    //         m_TargetChunk.voxelData[VoxelEngineChunk.VoxelDataIndex(m_localVoxelPos)] = new Voxel(0);
    ...
    //         m_TargetChunk.voxelData[VoxelEngineChunk.VoxelDataIndex((m_localVoxelPos + m_TargetBlockNormal).Value)] = new Voxel(1);
    //         m_TargetChunk.dirtyMesh = true;
    //         m_TargetChunk.BuildMesh();
    //     }
    // }
